...
m_vessels = [733,411,151;669,370,90;552,222,52];
...
for i = 1:3
    m = {['HA ',int2str(m_vessels(i,1)),'mg.ml'], ['HA ',int2str(m_vessels(i,3)),'mg.ml'],['HA ',int2str(m_vessels(i,2)),'mg.ml']};
    for s = phantom_size
        p = Copy_of_newPhantomGene(n_vessels,r_vessels,m);
